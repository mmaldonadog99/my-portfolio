...
>
    <h1 class="font-medium">
        <b class="font-bold poppins">Manuel</b> <span class="">Maldonado</span>
    </h1>
    ...
    <a href="https://www.linkedin.com/in/manuel-maldonado-gamarra-058045207/" target="_blank" class="blueShadow relative overflow-hidden px-5 py-2 group rounded-full bg-white text-slate-950">
