...
>
    ...
    <div class="flex flex-col gap-4 items-center justify-center">
        <p><b class="pr-2">Email</b> mmaldonadog99@gmail.com</p>
        <p>
            <b class="pr-2">GitHub</b>
            <a href="https://github.com/mmaldonadog99" target="_blank" class="text-violet-400"
                >Manuel Maldonado<sup class=""
        ...
        <p>
            ...
            <a href="https://www.linkedin.com/in/manuel-maldonado-gamarra-058045207/" target="_blank" class="text-violet-400"
                >Manuel Maldonado<sup class=""
                    ><span class="text-xs scale-75 pl-0.5"
                        ><i
                            class="fa-solid fa-arrow-up-right-from-square text-xs scale-[75%]"
